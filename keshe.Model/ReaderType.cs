...
namespace keshe.Model
{
    ...
    public class ReaderType
    {
        ...
        private Int32 _DateValid = 0;    /* 证书有效期（年） */
        #endregion

        #region 对私有字段的封装
        public int rdType { get => _rdType; set => _rdType = value; }
        ...
        public int DateValid { get => _DateValid; set => _DateValid = value; }
        #endregion
